...
codeEditor = "~/.config/hypr/hyprland/scripts/launch_first_available.sh 'zed' 'zeditor' 'windsurf' 'antigravity' 'code' 'codium' 'cursor' 'kate' 'gnome-text-editor' 'emacs' 'command -v nvim && kitty -1 nvim' 'command -v micro && kitty -1 micro'"
